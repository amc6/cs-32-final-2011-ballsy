...
public class Crosshair {
	...
	public void display() {
		...
		if (!_hidden) {
			...
			int ballX = (int) _player.getPixelPosition().x;
			int ballY = (int) _player.getPixelPosition().y;
	...
	public Point2D.Float getGrapplePoint(ArrayList<AbstractBody> bodies) {
		...
		int ballGX = (int) _player.getPixelPosition().x;
		int ballGY = (int) _player.getPixelPosition().y;
		...
		float ballX = _player.getWorldPosition().x;
		float ballY = _player.getWorldPosition().y;
