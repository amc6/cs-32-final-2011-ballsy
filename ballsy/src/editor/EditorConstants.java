...
public class EditorConstants {
	...
	public static final int BUTTON_BORDER_COLOR = Window.getInstance().color(255,255);
	public static final int BUTTON_INACTIVE_COLOR = Window.getInstance().color(255,100);
	public static final int BUTTON_ACTIVE_COLOR = Window.getInstance().color(255,255);
	public static final int BUTTON_HOVER_COLOR = Window.getInstance().color(255,180);
