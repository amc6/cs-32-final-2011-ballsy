...
public class Rectangle extends AbstractBody {
	...
	public Rectangle(AbstractLevel level, PhysicsWorld world){
		super(level, world, new physics.RectangleDef(CENTER_X, CENTER_Y, WIDTH, HEIGHT, DENSITY, FRICTION, BOUNCINESS), new graphical.RectangleDef(), true);
	}
	
	public Rectangle(AbstractLevel level, PhysicsWorld world, float centerX, float centerY){
		super(level, world, new physics.RectangleDef(centerX, centerY, WIDTH, HEIGHT, DENSITY, FRICTION, BOUNCINESS), new graphical.RectangleDef(), true);
	}
	...
	public Rectangle(AbstractLevel level, PhysicsWorld world, float centerX, float centerY, float width, float height, boolean mobile){
		super(level, world, new physics.RectangleDef(centerX, centerY, width, height, DENSITY, FRICTION, BOUNCINESS), new graphical.RectangleDef(), mobile);
	}
